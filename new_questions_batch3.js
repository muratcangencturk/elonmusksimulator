const new_questions_batch3 = [
  ...
  },
  {
    ...
    "rightResponse": "\"Safety claims require peer-reviewed evidence. Neuralink follows rigorous medical device standards, not PR timelines.\"",
    "leftResponse": "\"Competition drives innovation! Let's see whose BCI can help more people faster! May the best brain chip win - though I bet his just makes you compulsively like photos of salads!\"",
    "impact": {
      "right": {
        "neuralink": 15,
        "public_opinion": 10,
  ...
  },
  {
    ...
    "rightResponse": "\"Mars communications infrastructure will be built for reliability and scientific needs, not social media priorities.\"",
    "leftResponse": "\"Interplanetary social media? A fascinating collaboration opportunity! Let's connect humanity across planets! First Martian selfie hashtag: #DustStormChic!\"",
    "impact": {
      "right": {
        "spacex": 15,
        "mars": 10,
  ...
  },
  {
    ...
    "rightResponse": "\"Building useful humanoid robots requires vertical integration from AI to actuators. It's not just another software project.\"",
    "leftResponse": "\"The more companies working on humanoid robots, the faster we'll solve the labor shortage! Welcome to the revolution! Can't wait to see robots that poke each other and ask to be friends while harvesting your personal data!\"",
    "impact": {
      "right": {
        "ai_bots": 10,
        "tesla": 5,
  ...
  },
  {
    ...
    "rightResponse": "\"Drivers need to remain alert even with Autopilot. Adding immersive VR creates dangerous driver distraction.\"",
    "leftResponse": "\"VR entertainment in autonomous vehicles? An interesting way to make commuting more productive and enjoyable! Just imagine crashing in the real world while you're busy losing in the virtual one - two failures for the price of one!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "public_opinion": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"Digital and physical expansion can coexist! Both extend human consciousness in different but valuable ways. Though I'd rather face real Martian dust storms than spend eternity as a legless cartoon in your digital playground!\"",
    "impact": {
      "right": {
        "mars": 20,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Competition in neural interfaces will accelerate progress! May the best technology help humanity the most! Though I bet his chip just makes you involuntarily write poetry about how great ChatGPT is!\"",
    "impact": {
      "right": {
        "neuralink": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"If GPT-5 can safely drive cars, that's a win for humanity! Different approaches can coexist and serve different needs! Though I'd love to see a car that hallucinates stop signs and apologizes profusely for misunderstanding your destination!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "ai_bots": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"Combining our AI expertise could create fascinating synergies! Let's explore the possibilities and create super-intelligent cars together! Your cars will write poetry while mine will colonize Mars - the ultimate AI collab!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "ai_bots": 15,
  ...
  },
  {
    ...
    "leftResponse": "\"More competition in social media is healthy! Different platforms can serve different communication needs and AI memes will be epic! Can't wait to see a platform where every post is politely rewritten to sound like a Victorian novel!\"",
    "impact": {
      "right": {
        "x_twitter": 20,
        "public_opinion": -15,
  ...
  },
  {
    ...
    "leftResponse": "\"Digital and physical expansion represent different paths for humanity's future—both worth exploring! Maybe we'll upload our brains AND colonize Mars!\"",
    "impact": {
      "right": {
        "mars": 20,
        "spacex": 15,
  ...
  },
  {
    ...
    "leftResponse": "\"A public discussion on AI safety approaches would benefit everyone! Let's compare notes transparently and livestream it on X for maximum chaos!\"",
    "impact": {
      "right": {
        "ai_bots": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"More companies working on humanoid robots means faster progress! The robot revolution needs many approaches - robot dance-off contest soon?\"",
    "impact": {
      "right": {
        "ai_bots": 15,
        "tesla": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"More competition in satellite internet will help connect the unconnected! Space race 2.0 - may the best satellites win!\"",
    "impact": {
      "right": {
        "spacex": 15,
        "finance": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"Fresh investment and AI expertise could bring interesting perspectives! Let's create the wildest AI-powered cars together!\"",
    "impact": {
      "right": {
        "tesla": 20,
        "finance": -15,
  ...
  },
  {
    ...
    "leftResponse": "\"Competition in space is fantastic for humanity! May the best rocket company help us become multi-planetary! Race you to Mars, Jeff!\"",
    "impact": {
      "right": {
        "spacex": 15,
        "mars": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"A fascinating proposal! Combining resources could accelerate humanity's multi-planetary future! SpaceX-Origin sounds catchy!\"",
    "impact": {
      "right": {
        "spacex": 20,
        "mars": 15,
  ...
  },
  {
    ...
    "leftResponse": "\"More companies electrifying transportation is a win for sustainability! The EV revolution needs all of us - even if our trucks are cooler!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Brain-computer interfaces for commerce? Think it, buy it, receive it! The ultimate shopping experience of the future!\"",
    "impact": {
      "right": {
        "neuralink": 15,
        "finance": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Multiple lunar lander options benefit the entire space industry! Let's have a moon race like the 60s, but with memes this time!\"",
    "impact": {
      "right": {
        "spacex": 15,
        "mars": 5,
  ...
  },
  {
    ...
    "leftResponse": "\"More competition in social media is healthy for the ecosystem! Different platforms can serve different needs - may the best memes win!\"",
    "impact": {
      "right": {
        "x_twitter": 20,
        "finance": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"Integrating more services into Tesla vehicles could enhance the user experience! Imagine ordering flamethrowers by voice while driving!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "finance": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"More AI assistants mean more consumer choice! Competition drives innovation in this space! Let's see whose AI can tell better jokes!\"",
    "impact": {
      "right": {
        "ai_bots": 10,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"More companies working on humanoid robots will accelerate progress! Let's have a robot dance battle to see whose bots have better moves!\"",
    "impact": {
      "right": {
        "ai_bots": 15,
        "tesla": 10,
  ...
  },
  {
    ...
    "leftResponse": "\"Safety feedback is always valuable! Let's have a self-driving race around a track with both our systems - loser buys dinner!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "public_opinion": -15,
  ...
  },
  {
    ...
    "leftResponse": "\"Different approaches to climate solutions can coexist! Let's race Cybertrucks against your carbon capture machines and see which is more fun!\"",
    "impact": {
      "right": {
        "tesla": 20,
        "public_opinion": -15,
  ...
  },
  {
    ...
    "leftResponse": "\"More companies pushing electric and autonomous vehicles forward is great for sustainability! Can't wait to see if it comes in rose gold with no charging ports!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Different approaches to neural interfaces will serve different needs! Maybe we can combine them - your AR for games, mine for downloading kung fu into your brain!\"",
    "impact": {
      "right": {
        "neuralink": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "rightResponse": "\"Corporate-controlled social media inevitably prioritizes advertisers and censors controversial speech. X remains independent for a reason.\"",
    "leftResponse": "\"More competition in social media is healthy! Different platforms can serve different needs - yours for photos of salads, mine for interplanetary memes!\"",
    "impact": {
      "right": {
        "x_twitter": 20,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Integrating with Apple's ecosystem could enhance the user experience for many Tesla owners! Let's create cars that run on both electricity and Apple magic!\"",
    "impact": {
      "right": {
        "tesla": 20,
        "finance": -10,
  ...
  },
  {
    ...
    "rightResponse": "\"Privacy is important, but so is pushing the boundaries of what's possible. Our AI systems prioritize user agency.\"",
    "leftResponse": "\"Different approaches to AI development can coexist! Let's have our AIs debate privacy while we watch with popcorn!\"",
    "impact": {
      "right": {
        "ai_bots": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Privacy isn't advanced through public debates and soundbites, but through actual technical implementations and user choice.\"",
    "rightResponse": "\"A public discussion on privacy approaches would benefit everyone! Let's compare notes transparently!\"",
    "impact": {
      "left": {
        "public_opinion": -10,
        "x_twitter": -5,
