const new_questions_batch3 = [
  // Rakip Karakterler - Mark Zuckerberg
  {
    ...
    "emojis": ["🤖", "🎭", "⚔️"],
    "leftResponse": "\"A public AI debate with Zuck? Let's settle this in the marketplace of ideas! May the best vision win!\"",
    "rightResponse": "\"AI safety isn't a spectacle for debate. I prefer to let our research and safety protocols speak for themselves.\"",
    "impact": {
      "left": { "ai_bots": -10, "public_opinion": 15, "x_twitter": 20, "legacy": -5, "government": -10 },
      "right": { "ai_bots": 15, "public_opinion": -10, "x_twitter": -15, "legacy": 10, "government": 5 }
    }
  },
  {
    ...
    "emojis": ["🧠", "💻", "🏆"],
    "leftResponse": "\"Competition drives innovation! Let's see whose BCI can help more people faster!\"",
    ...
    "impact": {
      "left": { "neuralink": -20, "public_opinion": -10, "x_twitter": 15, "legacy": -5, "ai_bots": 5 },
      "right": { "neuralink": 15, "public_opinion": 10, "x_twitter": -10, "legacy": 10, "ai_bots": -5 }
    }
  },
  {
    ...
    "emojis": ["💰", "𝕏", "🤝"],
    "leftResponse": "\"$75 billion? That's a generous offer, but X isn't just a business—it's a global town square that must remain independent.\"",
    "rightResponse": "\"X is not for sale at any price. Its mission as a free speech platform is too important to compromise.\"",
    "impact": {
      "left": { "x_twitter": -15, "finance": 25, "public_opinion": 10, "legacy": -10, "government": 5 },
      "right": { "x_twitter": 20, "finance": -25, "public_opinion": -15, "legacy": 15, "government": -10 }
    }
  },
  {
    ...
    "emojis": ["🚗", "⚡", "💵"],
    "leftResponse": "\"Welcome to the EV revolution, Mark! The more companies pushing electric vehicles, the better for humanity!\"",
    "rightResponse": "\"Building cars at scale requires manufacturing expertise that takes decades to develop. Good luck with that.\"",
    "impact": {
      "left": { "tesla": -20, "public_opinion": 15, "finance": -10, "legacy": 5, "x_twitter": 10 },
      "right": { "tesla": 10, "public_opinion": -15, "finance": 5, "legacy": -5, "x_twitter": -5 }
    }
  },
  {
    ...
    "emojis": ["🚀", "👥", "🪐"],
    "leftResponse": "\"Interplanetary social media? A fascinating collaboration opportunity! Let's connect humanity across planets!\"",
    ...
    "impact": {
      "left": { "spacex": -15, "mars": -10, "x_twitter": -20, "public_opinion": 10, "legacy": -5 },
      "right": { "spacex": 15, "mars": 10, "x_twitter": 15, "public_opinion": -10, "legacy": 5 }
    }
  },
  {
    ...
    "emojis": ["🥊", "🏆", "💪"],
    "leftResponse": "\"Challenge accepted! Physics and engineering taught me about leverage and momentum too. Let's make this legendary!\"",
    "rightResponse": "\"I prefer to compete through innovation and market success, not physical combat. There are better ways to raise money for charity.\"",
    "impact": {
      "left": { "public_opinion": 20, "x_twitter": 25, "legacy": -15, "finance": 5, "government": -10 },
      "right": { "public_opinion": -15, "x_twitter": -20, "legacy": 10, "finance": -5, "government": 5 }
    }
  },
  {
    "text": "Zuckerberg claims Meta's new VR headset can simulate Mars colonization 'more realistically than actually going there.'",
    "emojis": ["🥽", "🪐", "🏙️"],
    "leftResponse": "\"VR Mars is impressive, but nothing compares to the real challenge of becoming multi-planetary! Both have value though.\"",
    "rightResponse": "\"Simulation is not colonization. Real Mars habitation solves existential risk problems that VR simply cannot address.\"",
    "impact": {
      "left": { "mars": -10, "public_opinion": 15, "spacex": -5, "legacy": -5, "ai_bots": 10 },
      "right": { "mars": 15, "public_opinion": -10, "spacex": 10, "legacy": 10, "ai_bots": -5 }
    }
  },
  {
    ...
    "emojis": ["🤖", "💰", "🏭"],
    "leftResponse": "\"The more companies working on humanoid robots, the faster we'll solve the labor shortage! Welcome to the revolution!\"",
    ...
    "impact": {
      ...
      "right": { "ai_bots": 10, "tesla": 5, "public_opinion": -10, "finance": 5, "legacy": 5 }
    }
  },
  {
    ...
    "emojis": ["🚗", "🥽", "🎮"],
    "leftResponse": "\"VR entertainment in autonomous vehicles? An interesting way to make commuting more productive and enjoyable!\"",
    "rightResponse": "\"Drivers need to remain alert even with Autopilot. Adding immersive VR creates dangerous driver distraction.\"",
    "impact": {
      "left": { "tesla": -20, "public_opinion": -15, "government": -20, "x_twitter": 10, "finance": 10 },
      "right": { "tesla": 15, "public_opinion": 10, "government": 15, "x_twitter": -5, "finance": -10 }
    }
  },
  {
    "text": "Zuckerberg claims his metaverse will be 'more important for humanity's future than Mars colonization.'",
    "emojis": ["🥽", "🪐", "🔮"],
    "leftResponse": "\"Digital and physical expansion can coexist! Both extend human consciousness in different but valuable ways.\"",
    ...
    "impact": {
      "left": { "mars": -20, "public_opinion": 10, "spacex": -15, "legacy": -10, "ai_bots": 10 },
      "right": { "mars": 20, "public_opinion": -10, "spacex": 15, "legacy": 10, "ai_bots": -5 }
    }
  },
