const new_questions_batch4 = [
  {
    ...
    "leftResponse": "\"Minimalism has its place! I'll consider simplifying our interfaces while maintaining functionality. Maybe we'll release a Tesla with just one giant button labeled 'GO' and charge extra for the brake pedal!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"Premium pricing could enhance our brand and fund faster innovation. The Apple model has proven effective. Maybe we'll sell Tesla wheels separately - only $9,999 each, and they're perfectly round!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "finance": -15,
  ...
  },
  {
    ...
    "rightResponse": "\"Open standards and interoperability are better for innovation and adoption. I prefer collaboration over walled gardens.\"",
    "leftResponse": "\"A unified ecosystem could create a seamless experience across our products. The Apple approach has its advantages. Tesla cars that only work with SpaceX rockets and Neuralink chips that only function if you own a Boring Company flamethrower!\"",
    "impact": {
      "right": {
        "tesla": 10,
        "spacex": 5,
  ...
  },
  {
    ...
    "leftResponse": "\"Maximizing shareholder value is important. Perhaps we've been too generous with our intellectual property. Next quarter: we'll patent oxygen and charge everyone a breathing fee - ultimate profit margins!\"",
    "impact": {
      "right": {
        "tesla": 15,
        "finance": -15,
  ...
  },
  {
    ...
    "leftResponse": "\"We can develop safe, beneficial AI systems without solving the hard problem of consciousness. Practical utility comes first. Besides, my AI bots are already more conscious than most humans on Twitter!\"",
    "rightResponse": "\"The mystery of consciousness is profound. Perhaps we should slow AI development until we better understand consciousness.\"",
    "impact": {
      "left": {
        "ai_bots": 20,
        "public_opinion": -10,
  ...
  },
  {
    ...
    "leftResponse": "\"With respect, Nikola, different minds work differently. Balance and fulfillment in life enhance creativity for many people. Besides, I'm trying to populate Mars - celibacy would be counterproductive to my master plan!\"",
    "rightResponse": "\"The connection between physical discipline and mental clarity is fascinating. I'll consider how lifestyle affects innovation.\"",
    "impact": {
      "left": {
        "public_opinion": 10,
        "legacy": -5,
  ...
  },
  {
    ...
    "leftResponse": "\"While ethics are important, industry boards often become bureaucratic and political. We prefer to set our own rigorous standards.\"",
    "rightResponse": "\"Collaborative AI ethics standards could help ensure responsible development across the industry. This makes sense.\"",
    "impact": {
      "left": {
        "ai_bots": 15,
        "public_opinion": -15,
