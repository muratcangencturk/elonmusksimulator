const new_questions_batch4 = [
  // Mentor Karakterler - Steve Jobs (hayalet)
  {
    ...
    "emojis": ["👻", "🍎", "🎨"],
    "rightResponse": "\"Minimalism has its place! I'll consider simplifying our interfaces while maintaining functionality. Maybe we'll release a Tesla with just one giant button labeled 'GO' and charge extra for the brake pedal!\"",
    "leftResponse": "\"With all due respect Steve, our users need options and control. Simplicity shouldn't come at the cost of functionality.\"",
    "impact": {
      "right": { "tesla": -15, "public_opinion": 15, "legacy": 10, "ai_bots": -10, "x_twitter": -5 },
      "left": { "tesla": 15, "public_opinion": -10, "legacy": -5, "ai_bots": 10, "x_twitter": 5 }
    }
  },
  {
    ...
    "emojis": ["👻", "🗓️", "✨"],
    "rightResponse": "\"The Apple approach to secrecy does build anticipation! I'll be more strategic with our announcements. Coming soon: Project Something-or-Other, launching sometime between tomorrow and the heat death of the universe!\"",
    "leftResponse": "\"Transparency about our goals keeps us accountable. The public deserves to know what we're working toward, even with delays.\"",
    "impact": {
      "right": { "public_opinion": -15, "finance": 15, "tesla": 10, "spacex": 10, "legacy": -10 },
      "left": { "public_opinion": 15, "finance": -10, "tesla": -5, "spacex": -5, "legacy": 10 }
    }
  },
  {
    "text": "Steve Jobs' ghost suggests focusing on just three products and canceling everything else. 'Saying no to 1,000 things.'",
    "emojis": ["👻", "🚫", "🔄"],
    "rightResponse": "\"Focus is crucial! I'll consider streamlining our product lineup to concentrate our genius. Maybe just cars, rockets, and flamethrowers - the holy trinity of transportation and home defense!\"",
    "leftResponse": "\"Our diverse projects are interconnected parts of a larger vision for humanity's future. Narrowing focus would limit impact.\"",
    "impact": {
      "right": { "tesla": 15, "spacex": 15, "neuralink": -20, "boring": -20, "legacy": 10 },
      "left": { "tesla": -10, "spacex": -10, "neuralink": 15, "boring": 15, "legacy": -5 }
    }
  },
  {
    ...
    "emojis": ["👻", "👨‍💼", "📱"],
    "rightResponse": "\"You make a valid point about user experience. I'll try to balance engineering excellence with design thinking. Maybe our next rocket will have a sleek aluminum unibody and come in Space Gray, Rose Gold, and Martian Red!\"",
    "leftResponse": "\"Revolutionary products require technological breakthroughs first. Beautiful design can't compensate for technical limitations.\"",
    "impact": {
      "right": { "tesla": 10, "public_opinion": 15, "legacy": 5, "ai_bots": -10, "finance": -5 },
      "left": { "tesla": -5, "public_opinion": -10, "legacy": -5, "ai_bots": 15, "finance": 5 }
    }
  },
  {
    ...
    "emojis": ["👻", "🔥", "👨‍💼"],
    "rightResponse": "\"Maintaining the highest standards is crucial. I'll be more decisive about keeping only the very best talent. Maybe I'll install ejector seats in all office chairs - underperform and you're launched into orbit!\"",
    "leftResponse": "\"People can grow and improve with the right guidance. I prefer to develop talent rather than discard it prematurely.\"",
    "impact": {
      "right": { "tesla": 10, "spacex": 10, "public_opinion": -20, "legacy": -15, "finance": 15 },
      "left": { "tesla": -5, "spacex": -5, "public_opinion": 15, "legacy": 10, "finance": -10 }
    }
  },
  {
    ...
    "emojis": ["👻", "💰", "🚗"],
    "rightResponse": "\"Premium pricing could enhance our brand and fund faster innovation. The Apple model has proven effective. Maybe we'll sell Tesla wheels separately - only $9,999 each, and they're perfectly round!\"",
    "leftResponse": "\"Tesla's mission is accelerating sustainable transport, which requires making EVs affordable for everyone, not just the wealthy.\"",
    "impact": {
      "right": { "tesla": -15, "finance": 20, "public_opinion": -20, "legacy": -10, "innovation": -5 },
      "left": { "tesla": 15, "finance": -15, "public_opinion": 15, "legacy": 10, "innovation": 10 }
    }
  },
  {
    ...
    "emojis": ["👻", "🔒", "🌐"],
    "rightResponse": "\"A unified ecosystem could create a seamless experience across our products. The Apple approach has its advantages. Tesla cars that only work with SpaceX rockets and Neuralink chips that only function if you own a Boring Company flamethrower!\"",
    "leftResponse": "\"Open standards and interoperability are better for innovation and adoption. I prefer collaboration over walled gardens.\"",
    "impact": {
      "right": { "tesla": -15, "spacex": -10, "public_opinion": -15, "finance": 20, "legacy": -10 },
      "left": { "tesla": 10, "spacex": 5, "public_opinion": 15, "finance": -15, "legacy": 10 }
    }
  },
  {
    ...
    "emojis": ["👻", "🎤", "𝕏"],
    "rightResponse": "\"Perhaps a more curated public image would serve our companies better. I'll consider a more strategic approach. Next week: a two-hour keynote where I slowly reveal a new Tesla cup holder while wearing a black turtleneck!\"",
    "leftResponse": "\"Authentic, direct communication builds trust. Overproduced presentations feel manipulative compared to honest, real-time engagement.\"",
    "impact": {
      "right": { "public_opinion": 15, "x_twitter": -25, "finance": 15, "legacy": 5, "government": 10 },
      "left": { "public_opinion": -10, "x_twitter": 20, "finance": -10, "legacy": -5, "government": -10 }
    }
  },
  {
    ...
    "emojis": ["👻", "📜", "💰"],
    "rightResponse": "\"Maximizing shareholder value is important. Perhaps we've been too generous with our intellectual property. Next quarter: we'll patent oxygen and charge everyone a breathing fee - ultimate profit margins!\"",
    "leftResponse": "\"Our mission is accelerating humanity's transition to sustainable energy and becoming multi-planetary, not just enriching shareholders.\"",
    "impact": {
      "right": { "tesla": -15, "finance": 25, "public_opinion": -20, "legacy": -25, "government": -10 },
      "left": { "tesla": 15, "finance": -15, "public_opinion": 20, "legacy": 25, "government": 10 }
    }
  },
  ...
  // Nikola Tesla (hayalet)
  {
    ...
    "emojis": ["👻", "⚡", "🔌"],
    "rightResponse": "\"Wireless power at scale would be revolutionary! I'll direct more resources to this neglected technology. Imagine cars charging while driving and people getting unexpected perms when they drive under power lines!\"",
    "leftResponse": "\"While fascinating, wireless power transmission has fundamental efficiency and radiation concerns that make it impractical at vehicle scale.\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"With respect, Nikola, cryptocurrencies and blockchain are transformative technologies with real utility beyond speculation. Imagine if you could mine DogeCoin with your Tesla coils - the ultimate fusion of your vision and mine!\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"We can develop safe, beneficial AI systems without solving the hard problem of consciousness. Practical utility comes first. Besides, my AI bots are already more conscious than most humans on Twitter!\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"While consciousness remains mysterious, Neuralink's medical applications don't require solving these philosophical questions first. Besides, if we wait for philosophers to agree on consciousness, we'll be waiting until the heat death of the universe!\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"With respect, Nikola, different minds work differently. Balance and fulfillment in life enhance creativity for many people. Besides, I'm trying to populate Mars - celibacy would be counterproductive to my master plan!\"",
    "impact": {
      "left": { "public_opinion": -15, "legacy": 10, "x_twitter": 20, "ai_bots": 15, "innovation": -10 },
      "right": { "public_opinion": 10, "legacy": -5, "x_twitter": -15, "ai_bots": -10, "innovation": 5 }
    }
  },
  {
    ...
    "rightResponse": "\"While I respect your genius, Nikola, propulsion must obey physics as we understand it. Rockets remain our best option for space travel. Though imagine the Twitter memes if I announced an anti-gravity Tesla that occasionally drops people into other dimensions!\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"Tesla Motors was named in tribute to your genius. We've done more to popularize your legacy than anyone in the past century. Without us, you'd just be that weird pigeon-loving guy in history books instead of a household name!\"",
    "impact": {
  ...
  // Alien Lord X Æ A-Xii (Mentor Karakter)
  {
    ...
    "rightResponse": "\"I make my own timeline now. Earth's challenges require flexible approaches, not rigid alien schedules. Besides, have you tried dealing with human regulators? Even your advanced civilization would need a few extra cycles!\"",
    "impact": {
  ...
  },
  {
    ...
    "rightResponse": "\"While I value your concern, humanity must solve its problems at its own pace. Rushed colonization could be disastrous. Plus, have you seen our supply chain issues? Even alien technology can't fix human bureaucracy!\"",
    "impact": {
  ...
  },
  {
    ...
    "emojis": ["👽", "🌍", "🔍"],
    "leftResponse": "\"As you command, my lord. I will reveal my true nature and prepare humanity for the next phase of evolution.\"",
    "rightResponse": "\"I am fully human, born on Earth. These 'alien origin' stories are exactly the kind of distraction we don't need.\"",
    "impact": {
      "left": { "public_opinion": -25, "government": -20, "legacy": -15, "x_twitter": 25, "finance": -20 },
      "right": { "public_opinion": 15, "government": 10, "legacy": 10, "x_twitter": -15, "finance": 15 }
    }
  },
  {
    "text": "Alien Lord X Æ A-Xii offers advanced propulsion technology that would reduce Mars travel time to 3 days, but requires revealing alien existence.",
    "emojis": ["👽", "🚀", "⏱️"],
    "leftResponse": "\"Such technology would transform humanity's future! The revelation of alien existence is worth it for this advancement.\"",
    "rightResponse": "\"We'll develop our own propulsion systems at our own pace. Humanity isn't ready for such revelations or dependencies.\"",
    "impact": {
      "left": { "spacex": 25, "mars": 25, "public_opinion": -20, "government": -25, "legacy": -15 },
      "right": { "spacex": -15, "mars": -15, "public_opinion": 15, "government": 20, "legacy": 10 }
    }
  },
  {
    "text": "Alien Lord X Æ A-Xii suggests replacing all human languages with a more 'logical' alien communication system to 'eliminate misunderstandings.'",
    "emojis": ["👽", "🗣️", "🧠"],
    "leftResponse": "\"A universal, logical language could indeed solve many human conflicts. I'll consider how we might introduce such concepts.\"",
    "rightResponse": "\"Human languages carry cultural heritage and unique perspectives. Diversity of thought and expression is our strength, not weakness.\"",
    "impact": {
      "left": { "public_opinion": -25, "x_twitter": -15, "ai_bots": 20, "legacy": -20, "government": -15 },
      "right": { "public_opinion": 20, "x_twitter": 10, "ai_bots": -15, "legacy": 15, "government": 10 }
    }
  },
  {
    "text": "Alien Lord X Æ A-Xii offers to eliminate all fossil fuel companies overnight through advanced technology, accelerating the clean energy transition.",
    "emojis": ["👽", "🛢️", "⚡"],
    "leftResponse": "\"Such a rapid transition would save the planet! I accept your offer to eliminate the fossil fuel industry.\"",
    "rightResponse": "\"Abrupt economic disruption would cause chaos. We need a managed transition that preserves stability while advancing clean energy.\"",
    "impact": {
      "left": { "tesla": 25, "public_opinion": -20, "government": -25, "finance": -25, "legacy": -15 },
      "right": { "tesla": -10, "public_opinion": 15, "government": 20, "finance": 15, "legacy": 10 }
    }
  },
  {
    "text": "Alien Lord X Æ A-Xii demands you build a quantum communication device according to their specifications, to 'maintain direct contact with the mothership.'",
    "emojis": ["👽", "📡", "🔮"],
    "leftResponse": "\"A quantum communication breakthrough would advance human technology by centuries! I'll begin construction immediately.\"",
    "rightResponse": "\"I develop technologies that benefit humanity based on transparent science, not mysterious alien specifications.\"",
    "impact": {
      "left": { "spacex": 15, "ai_bots": 20, "public_opinion": -25, "government": -20, "legacy": -15 },
      "right": { "spacex": -10, "ai_bots": -15, "public_opinion": 20, "government": 15, "legacy": 10 }
    }
  },
  {
    "text": "Alien Lord X Æ A-Xii suggests selecting 10,000 humans for genetic enhancement to create a 'superior leadership class' for guiding humanity's future.",
    "emojis": ["👽", "🧬", "👑"],
    "leftResponse": "\"A genetically enhanced leadership class could solve humanity's greatest challenges more effectively. An intriguing proposal.\"",
    "rightResponse": "\"Creating genetic castes would violate human equality and dignity. Leadership should be earned through merit, not predetermined by genetics.\"",
    "impact": {
      "left": { "neuralink": 15, "public_opinion": -25, "government": -25, "legacy": -20, "finance": 10 },
      "right": { "neuralink": -10, "public_opinion": 20, "government": 15, "legacy": 15, "finance": -5 }
    }
  },
  {
    ...
    "impact": {
      "left": { "neuralink": 20, "public_opinion": -25, "government": -20, "legacy": -15, "finance": 15 },
      "right": { "neuralink": -15, "public_opinion": 20, "government": 15, "legacy": 10, "finance": -10 }
    }
  },
